...
const CartList=()=>{
    ...
    const bike=[
        {id:"dsihdi78", name:"Pinarello Bike", subText:"Mountain Bike", price:"1,700.00" },
        {id:"dsh98", name:"Brompton Bike", subText:"Road Bike", price:"1,500.00"},
        {id:"2389cj", name:"Schwim Bike", subText:"Urban Bike", price:"1,200.00"},
    ]
    ...
    return (
      ...
      <View style={styles.bikes}>
          ...
          data={bike}
          renderItem={({ item }) => {
            return <CheckoutCard subText={item.subText} name={item.name} price={item.price} />;
          }}
          keyExtractor={(item) => {
            item.id;
          }}
